...
Valid values are in the range [2-32], inclusive. The size of the hash generated by ghash is equal to `resolution^2` bits. The default resolution is 8, generating a 64-bit hash. Smaller resolutions increase fuzziness (see Supplemental).
